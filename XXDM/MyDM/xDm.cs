...
namespace xDM
{
    ...
    public class xDm :IxDm
    {
        ...
        /// <returns>0:失败1:成功</returns>
        public  int KeyPress(KeyCode vk)
        {
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public  int MoveTo(MouseEnum mouseClick, int x, int y)
        {
            int i = dm.MoveTo(x, y);
            if (mouseClick == MouseEnum.鼠标左键)
            {
                i = i + LeftClick();
            }
            else if (mouseClick == MouseEnum.鼠标右键)
            {
                i = i + RightClick();
            }
